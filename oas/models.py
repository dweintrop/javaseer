...
class PencilCodeEvent(models.Model):
  ...
  EditorMode = models.CharField(max_length=30) # state of droplet editor -> (blocks, text)
  PaletteVisible = models.CharField(max_length=30) # state of droplet palette -> (true/false)
